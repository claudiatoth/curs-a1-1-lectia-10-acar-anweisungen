...
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Starke Verben + Imperativ + verbe separabile</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillInBlock('Übung 1 — Vokalwechsel e → i / ie (pers. II + III sg.)', 'lesen → du liest, er liest · nehmen → du nimmst, er nimmt · essen → du isst, er isst · helfen → du hilfst, er hilft.', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += fillInBlock('Übung 2 — Vokalwechsel a → ä (pers. II + III sg.)', 'fahren → du fährst, er fährt · schlafen → du schläfst, er schläft. NU se aplică la ich, wir, ihr, sie.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillInBlock('Übung 3 — Imperativ pentru „du" (verbe TARI)', 'Verbe TARI cu e→i/ie: păstrează vocala schimbată + scoți „st"! nehmen → Nimm! · lesen → Lies! · helfen → Hilf! Verbele cu a→ä: NU păstrează Umlaut: fahren → Fahr! (NU Fähr!)', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillInBlock('Übung 4 — Imperativ pentru „ihr" (forma persoanei a II-a plural)', 'Pur și simplu forma de ihr a verbului, fără pronume: ihr nehmt → Nehmt! · ihr lest → Lest!', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += fillInBlock('Übung 5 — Verbe separabile + Imperativ', 'Verbele separabile (aufmachen, anrufen, einkaufen...): prefix la SFÂRȘIT. La imperativ: verbul conjugat + obiectul + prefixul la sfârșit. „Mach das Fenster auf!"', ex5Data);
        }
        return html;
    }
